...
public class multiplayer extends javax.swing.JFrame {
    ...
    public multiplayer() {
        ...
        try {
          ...
          while (myReader.hasNextLine()) {
            String tmp = myReader.nextLine();
                if (tmp.equals("oacc")) {
                    xicon.setIcon(new ImageIcon(getClass().getResource("avatarmpno.png")));
                    opicon.setIcon(new ImageIcon(getClass().getResource("avatarmp.png")));
                }
          }
    ...
    private void initComponents() {
        ...
        opicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tris_/avatarmpno.png"))); // NOI18N
