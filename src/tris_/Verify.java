...
public class Verify extends javax.swing.JFrame {
    ...
    public Verify() {
        ...
        setLocationRelativeTo(null);
         ...
         try {
          ...
          File myObj = new File("mailtemp.txt");
          Scanner myReader = new Scanner(myObj);  
          while (myReader.hasNextLine()) {
            String data = myReader.nextLine();
            
            code = random();
            mail(data,"Utente", code);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("2. Verify your Email");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, -1, -1));

        codice.setBackground(java.awt.Color.darkGray);
        codice.setForeground(new java.awt.Color(255, 255, 255));
        codice.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        codice.setName(""); // NOI18N
        codice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                codiceActionPerformed(evt);
            }
        });
        jPanel1.add(codice, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 130, 30));

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("sent to your Email.");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 440, -1));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tris_/quit.png"))); // NOI18N
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 230, 180, -1));

        jLabel7.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("In order to continue we need to verify your");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 110, 440, -1));

        jLabel8.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Email address, please enter the code we");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String temp = code + "";
        if (codice.getText().equals(temp)) {
            System.out.println("DEBUG: codice inserito: corretto");
            this.setVisible(false);
            new theme().setVisible(true);
        } else {
            System.out.println("DEBUG: codice inserito: errato");
            new ERR_Code().setVisible(true);
        }
