 ...
 * @author andrea
 */
public class setupcomplete extends javax.swing.JFrame {

    /**
     * Creates new form setupcomplete
     */
    public setupcomplete() {
        initComponents();
        setLocationRelativeTo(null);
        jPanel1.setBackground(new Color(0, 204, 255));
        try (FileWriter scrivi = new FileWriter("setup.txt")) {
                            scrivi.write("complete");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("4. Complete");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, -1, -1));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tris_/end.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(setupcomplete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
